...
export class TransferToCrible {
   id: number;
   dateCreation: Date;
   quantityTransfer: number;
   referenceCribleVert:string;


  constructor(_id: number=0, _dateCreation: Date=new Date, _quantityTransfer: number=0, _referenceCribleVert: string="") {
    this.id = _id;
    this.dateCreation = _dateCreation;
    this.quantityTransfer = _quantityTransfer;
    this.referenceCribleVert = _referenceCribleVert;
  }
